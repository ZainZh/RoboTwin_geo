...
data_config="${DATA_CONFIG:-demo_clean_3d_object_pc_geometry_marker_densecontrol_pilot}"
root="${artifact_root}/processed_datasets/fulltask_tagrt_v2/${run_name}"
data_dir="${artifact_root}/simulator_data/place_shoe_geometry_marker/${data_config}/data"
