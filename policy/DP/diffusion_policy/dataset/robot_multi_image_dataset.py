...
class RobotMultiImageDataset(BaseImageDataset):
    def __init__(
        self,
        zarr_path,
        horizon=1,
    ...
    def get_normalizer(self, mode="limits", **kwargs):
        ...
        for obs_key in OBS_CAMERA_KEYS.values():
    ...
    def postprocess(self, samples, device):
        ...
        for zarr_key, obs_key in OBS_CAMERA_KEYS.items():
            obs[obs_key] = samples[zarr_key].to(device, non_blocking=True) / 255.0
