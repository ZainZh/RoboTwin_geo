...
\end{figure*}
  ...
  Utonia~\citep{zhang2026utonia} as $E(\cdot)$ and keep it frozen, so that semantic field learning builds on general 3D geometric priors rather than relearning low-level geometry.
