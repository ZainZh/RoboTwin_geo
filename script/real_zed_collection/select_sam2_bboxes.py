...
DEFAULT_RAW_ROOT = "/media/zheng/Extreme SSD/geo_mani_data/car/real_zed_raw"
DEFAULT_OUTPUT_ROOT = "/media/zheng/Extreme SSD/geo_mani_data/car/sam2_bbox_prompts"
