...
DEFAULT_RAW_ROOT = "/media/zheng/Extreme SSD/geo_mani_data/pour_water/real_zed_raw"
DEFAULT_OUTPUT_ROOT = "/media/zheng/Extreme SSD/geo_mani_data/pour_water/sam2_bbox_prompts"
