...
DEFAULT_RAW_ROOT = "/media/zheng/Extreme SSD/geo_mani_data/teapot/real_zed_raw"
DEFAULT_OUTPUT_ROOT = "/media/zheng/Extreme SSD/geo_mani_data/teapot/sam2_bbox_prompts"
