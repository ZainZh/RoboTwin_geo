...
DEFAULT_RAW_ROOT = "/media/zheng/Extreme SSD/geo_mani_data/new_press/real_zed_raw"
DEFAULT_OUTPUT_ROOT = "/media/zheng/Extreme SSD/geo_mani_data/new_press/sam2_bbox_prompts"
